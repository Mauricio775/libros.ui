...
const InventoryForm = ({ item, book, onSuccess, onCancel }) => {
    ...
    const handleSubmit = async () => {
        ...
        if (!formData.id_book.trim()) {
            setError('El tipo de libro es requerido');
            return;
        }
    ...
    const activeBook = book.filter(type => type.active);
            ...
            <div className="bg-white rounded-lg shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
                <div className="p-6">
                    ...
                    <div className="space-y-4">
                        <div>
                            <label htmlFor="id_book" className="block text-sm font-medium text-gray-700 mb-1">
                                Libros *
                            </label>
                            <select
                                id="id_book"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-sky-500"
                                placeholder="Ej: Inventario Infantil"
                                maxLength="100"
                                autoFocus={!item}
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows="3"
                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-sky-500"
                                placeholder="Descripción detallada del Inventario..."
                                maxLength="500"
                            />
                        </div>
                    ...
                    <div className="flex justify-end space-x-3 mt-6">
                        ...
                        <button
                            ...
                            disabled={isSubmitting}
                            className="px-4 py-2 text-sm font-medium text-white bg-sky-500 hover:bg-sky-600 rounded-md disabled:opacity-50 transition-colors"
                        >
