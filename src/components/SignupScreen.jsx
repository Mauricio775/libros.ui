        ...
        <div className="min-h-screen bg-sky-50 flex items-center justify-center p-4">
            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-gray-800">Tienda de Libros</h1>
                    ...
                    <div className={`mb-4 p-3 rounded-md border ${
                        ...
                        {(error.includes('email ya está registrado') || error.includes('usuario ya existe')) && (
                            <div className="mt-2 text-sm">
                                <Link to="/login" className="text-sky-600 hover:text-sky-700 underline">
                ...
                <form className="space-y-4" noValidate>
                    ...
                    <button
                        ...
                        className="w-full bg-sky-500 text-white py-2 px-4 rounded-md hover:bg-sky-600 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                    >
